...
const ClienteCorreo = require('./servidor/servidorEmail');
...
ipcMain.on('enviarCorreo', function(event, templateCorreo) {
  console.log(typeof ClienteCorreo);
  let clientecorreo = new ClienteCorreo();
  clientecorreo.enviarCorreo(templateCorreo);
});
